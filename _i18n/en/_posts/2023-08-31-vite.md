...
![Vite and webpack](/assets/img/2023/08/vite-1.png)
...
![Brief history of construction tools](/assets/img/2023/08/module-history.png)
...
* The ESM specification appears, webpack, and Rollup appear. Webpack supports AMD\CommonJS\ESM, babel, style preprocessing and various MVC frameworks, becoming mainstream. frameworks, becoming mainstream.
Webpack supports AMD\CommonJS\ESM, babel, style preprocessing and various MVC frameworks, becoming mainstream. * ESM browser native support, esbuild appears, and build tools (Vite, Snowpack) that rely on esbuild appear.

See details[A brief history of front-end build tools](/posts/build-tool-history).
...
The larger the project application, the longer the startup time. [webpack server](/assets/img/2023/08/bundle-server.png)
...
[vite server](/assets/img/2023/08/vite-server.png) [vite server](/assets/img/2023/08/vite-server.png)
...
![Vite hot update](/assets/img/2023/08/hot-update.png)
...
![Vite hot update](/assets/img/2023/08/vite-hot.png)
...
* [Vite official website documentation](https://cn.vitejs.dev/guide/why.html)
* [Vite introduction and realization principle](https://zhuanlan.zhihu.com/p/424842555)
* [In-depth vite principle: You Da's latest masterpiece is actually how to realize it?] (https://zhuanlan.zhihu.com/p/467325485)
* [Front-end build tools evolution history](https://juejin.cn/post/7205766006253011004#heading-10)
* [Webpack and Vite hot update difference comparison](https://www.cnblogs.com/dengyao-blogs/p/16697332.html)
